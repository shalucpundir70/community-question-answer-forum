...
class CommunityQAHelper{
    ...
    public function register_post_type(){
        ...
        echo $qaf_capabilities_tag = 'post';
        //get post type 
    ...
    public function load_module(){
        ...
        include_once COMMUNITY_QA_PLUGIN_DIR . '/modules/questions.php';
        include_once COMMUNITY_QA_PLUGIN_DIR . '/modules/listquestions.php';
